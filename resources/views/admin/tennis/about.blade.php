...
@section('content')
<div class="bg-img">
    <h1 class="d-block text-white bg-info">サイトについて</h1>
    <div class="container">
...
<div>
     ...
     <div class="container border-top">
         ...
         <ul class="navbar-nav ml-auto">
            <li>プレーヤーの方は「エントリーユーザー」として登録し、現在募集中の大会・練習会情報</li>
            <li>を地域をしぼって検索し、申込みができます。</li>
            <li>大会や練習会、気になる大会を「お気に入り」にいれておき、参加者募集の情報を受け取</li>
            <li>ることも可能です。</li>
         </ul>
     </div>
</div>
